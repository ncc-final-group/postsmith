...
import QuickLinks from '@components/QuickLinks'; // 추가!
...
export default function RootPage() {
  ...
  const [isLoggedIn, setIsLoggedIn] = useState(false); // ★ 임시로 true/false 바꿔보기
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gray-100">
      <main className="mx-auto w-full max-w-7xl min-w-[900px] flex-grow py-10">
        <div className="flex min-w-0 gap-8">
          ...
          <aside className="flex min-w-0 basis-2/5 flex-col">
            ...
            {isLoggedIn ? (
              ...
              // 비로그인 시
              <div className="mb-6 flex w-full flex-col items-center rounded-lg bg-white p-10 shadow justify-center">
                <span className="mb-4 text-lg font-bold text-gray-700">로그인이 필요한 서비스 입니다</span>
                <Link href="/login" className="rounded bg-blue-500 px-6 py-2 text-white font-medium hover:bg-blue-600 transition">
                  로그인 하기
                </Link>
              </div>
            )}
