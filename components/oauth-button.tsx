...
export default function OAuthButton({ provider }: { provider: ProviderType }) {
  function handleOnClick() {
    console.log(process.env.NEXT_PUBLIC_API_SERVER + `/oauth2/authorize/${provider}`);
  ...
  const providerIcons = {
    google: <Image src="/logo/google.svg" alt="Github Logo" width={20} height={20} className="w-auto" />,
    github: <Image src="/logo/github.svg" alt="Github Logo" width={20} height={20} className="w-auto" />,
    kakao: <Image src="/logo/kakao.svg" alt="Github Logo" width={20} height={20} className="w-auto" />,
    naver: <Image src="/logo/naver.svg" alt="Github Logo" width={20} height={20} className="w-auto" />,
  };
